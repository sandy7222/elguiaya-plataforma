...
void main() async {
  final url = Uri.parse('https://ymgsxwfwntbqvguvbhoa.supabase.co/rest/v1/cotizaciones?limit=1');
  ...
  final url2 = Uri.parse('https://ymgsxwfwntbqvguvbhoa.supabase.co/rest/v1/presupuestos?limit=1');
